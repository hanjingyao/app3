...
describe('Service Tests', () => {
    ...
    describe('TestRequiredMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TestRequiredMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/test-requireds';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TestRequiredMySuffix', () => {

                let entity: TestRequiredMySuffix;
                service.find(123).subscribe((_entity: TestRequiredMySuffix) => {
                    entity = _entity;
                });
