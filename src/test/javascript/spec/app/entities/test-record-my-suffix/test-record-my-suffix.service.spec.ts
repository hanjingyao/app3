...
describe('Service Tests', () => {
    ...
    describe('TestRecordMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TestRecordMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/test-records';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TestRecordMySuffix', () => {

                let entity: TestRecordMySuffix;
                service.find(123).subscribe((_entity: TestRecordMySuffix) => {
                    entity = _entity;
                });
