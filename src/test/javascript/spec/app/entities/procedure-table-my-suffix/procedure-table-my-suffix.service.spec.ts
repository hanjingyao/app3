...
describe('Service Tests', () => {
    ...
    describe('ProcedureTableMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProcedureTableMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/procedure-tables';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProcedureTableMySuffix', () => {

                let entity: ProcedureTableMySuffix;
                service.find(123).subscribe((_entity: ProcedureTableMySuffix) => {
                    entity = _entity;
                });
