...
describe('Service Tests', () => {
    ...
    describe('OrderTableMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrderTableMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/order-tables';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OrderTableMySuffix', () => {

                let entity: OrderTableMySuffix;
                service.find(123).subscribe((_entity: OrderTableMySuffix) => {
                    entity = _entity;
                });
