...
describe('Service Tests', () => {
    ...
    describe('TestResultMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TestResultMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return TestResultMySuffix', () => {

                let entity: TestResultMySuffix;
                service.find(123).subscribe((_entity: TestResultMySuffix) => {
                    entity = _entity;
                });
