...
describe('Service Tests', () => {
    ...
    describe('TestRecordingMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TestRecordingMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/test-recordings';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TestRecordingMySuffix', () => {

                let entity: TestRecordingMySuffix;
                service.find(123).subscribe((_entity: TestRecordingMySuffix) => {
                    entity = _entity;
                });
